...
person.age = 20;
console.log(person.age); // const propertyToCheck = prompt('what do you want to check?');
// console.log(propertyToCheck);
// console.log(person[propertyToCheck]);

var personFroze = Object.freeze(person);
console.log(person); // you cannot find these string variables without this exact notation

console.log(person['cool-dude']);
var nameInput = document.querySelector("[name=\"first\"]");
var name = nameInput ? nameInput.value : '';
console.log(name);
console.log(delete person.dog); // ! A METHOD IS A FUNCTION THAT LIVES INSIDE OF AN OBJECT

var name1 = 'wes';
var name2 = 'wes';
console.log(name1 === name2);
name1 = 'scott';
console.log(name1 === name2); // & update name1 to be what is name2
...
var person4 = _.cloneDeep(person1);
...
var inventory = _objectSpread(_objectSpread(_objectSpread({}, meatInventory), veggieInventory), {}, {
  oyster: 15,
  fish: 15
...
},{}]},{},["../../../../.npm-global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","objects.js"], null)
//# sourceMappingURL=/objects.80db8f08.js.map