...
async function handleResult({
  ...
  color = color.replace(/\s/g, ''); // check if it is a valid colours
  ...
  console.log(color); // change color background

  document.body.style.background = `${color}`;
  console.log((0, _colors.isDark)(color));

  if ((0, _colors.isDark)(color) === true) {
...
},{"waait":"node_modules/waait/index.js","./colors":"colors.js"}],"speech.js":[function(require,module,exports) {
"use strict";
...
function displayColors(colors) {
  return colors.map(color => `<span class="color ${(0, _colors.isDark)(color) ? 'dark' : ''}"
        id="${color}"
