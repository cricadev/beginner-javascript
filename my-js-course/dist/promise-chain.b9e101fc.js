...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"promise-chain.js":[function(require,module,exports) {
"use strict";
...
function animate(e) {
  var el = e.currentTarget; // 1. change the text to GO when clicked.

  el.textContent = 'GO!'; // 2. Make it a circle after 2 seconds.
...
function animate2(_x) {
  return _animate.apply(this, arguments);
}

function _animate() {
  _animate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var el;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            el = e.currentTarget; // 1. change the text to GO when clicked.
...
go.addEventListener('clickzzz', function (e) {
  var el = e.currentTarget;
  el.textContent = 'GO!'; // 2. Make it a circle after 2 seconds.

  setTimeout(function () {
    el.classList.add('circle'); // 3. Make it red after 0.5 seconds.

    setTimeout(function () {
      el.classList.add('red'); // 4. Make it a square after 0.25 seconds.

      setTimeout(function () {
        el.classList.remove('circle'); // 5. Make it purple after 0.3 seconds.

        setTimeout(function () {
          el.classList.remove('red');
          el.classList.add('purple'); // 6. Make it fade out after 1 second.
...
},{}]},{},["../../../../.npm-global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","promise-chain.js"], null)
//# sourceMappingURL=/promise-chain.b9e101fc.js.map