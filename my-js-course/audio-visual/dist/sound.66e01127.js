...
async function getAudio() {
  ...
  analyzer.fftSize = 2 ** `${localStorage.getItem('options') ? localStorage.getItem('options') : 5}`;
...
function drawTimeData(timeData) {
  ...
  ctx.clearRect(0, 0, canvas.width, canvas.height); // 2. setup some canvas drawing

  ctx.lineWidth = `${localStorage.getItem('width') ? localStorage.getItem('width') : 1}`;
  ctx.strokeStyle = `${localStorage.getItem('color') ? localStorage.getItem('color') : '#ffffff'}`;
  ctx.beginPath();
...
},{"waait":"node_modules/waait/index.js","./utils":"utils.js","./controls":"controls.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
